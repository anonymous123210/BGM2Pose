...
class Config:
    ...
    spec_duration: float = 0.6

    dataset_name: str = "action_segmentation"

    input_feature: str = "all"
    ...
    def _value_check(self) -> None:
        ...
        #     if (self.dataset_name.split('_')[-3] == 'timeseries') | (self.dataset_name.split('_')[-3] == 'kfold'):
        #         pass
        #     else:
        #         message = (
