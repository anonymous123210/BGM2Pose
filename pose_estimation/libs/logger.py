...
class TrainLogger(object):
    ...
    def update(
        ...
        train_time: int,
        train_loss: float,
        train_clip_loss: float,
        train_logit_scale: float,
        train_rmse: float,
        train_mae: float,
        train_acc: float,
        val_time: int,
        ...
        logger.info(
            f"epoch: {epoch}\tepoch time[sec]: {train_time + val_time}\tlr: {lr}\t"
            f"train loss: {train_loss:.4f}\ttrain clip loss: {train_clip_loss:.4f}\ttrain logit scale: {train_logit_scale:.4f}\tval loss: {val_loss:.4f}\t"
